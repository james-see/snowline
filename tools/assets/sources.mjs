...
export const TREE_MODELS = [
  {
    id: 'tree_pine_0',
    kit: 'kenney_nature',
    obj: 'Models/OBJ format/tree_pineTallB_detailed.obj',
    scale: 5.5,
    variant: 0,
    note: 'Detailed tall pine — branchier canopy base for needle cards.',
  },
  {
    id: 'tree_pine_1',
    kit: 'kenney_nature',
    obj: 'Models/OBJ format/tree_pineTallC_detailed.obj',
    scale: 5.5,
    variant: 1,
    note: 'Detailed tall pine B — belt silhouette variation.',
  },
  {
    id: 'tree_pine_2',
    kit: 'kenney_nature',
    obj: 'Models/OBJ format/tree_pineTallD_detailed.obj',
    scale: 5.5,
    variant: 2,
    note: 'Detailed tall pine C — mid-forest fill variation.',
  },
];
