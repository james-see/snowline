...
export const ALPINE_FLOW: CourseDef = {
  ...
  terrain: {
    ...
    apronT: 0.2,
    drop: 300,
    // Denser samples so chase-scale rollers / corduroy geo resolve on groom path.
    pathSegmentsPer100m: 22,
    lateralSegments: 40,
    pitchDeg: 13,
    roughness: 0.38,
    reliefScale: 1.25,
  ...
  props: [
    ...
    // Terrain park — path-relative. Early cluster sits in spawn/grind chase frustum
    // (camera look-ahead ~8 m; harness grind is still near start). Later terrace
    // keeps the mid/late rail district. Soft right offsets — not apron void.
    {
      id: 'ramp-intro',
      kind: 'ramp',
      position: [0, 0, 0],
...
export const TIMBERLINE: CourseDef = {
  ...
  props: [
    ...
    // Light park language — keep narrow chute fair; features hug edges / glade.
    {
      id: 'rail-chute',
      kind: 'rail',
      position: [0, 0, 0],
