...
export const ALPINE_FLOW: CourseDef = {
  ...
  props: [
    ...
    // Terrain park — path-relative so features sit on the right terrace / soft offsets.
    // Corridor center stays mostly clear; density is readable arcade park language.
    {
      id: 'ramp-intro',
      kind: 'ramp',
      position: [0, 0, 0],
