...
export const ALPINE_FLOW: CourseDef = {
  ...
  terrain: {
    ...
    // Tall peaks + near amphitheater bowl fill course_start midfield mass.
    backdrop: { peakHeight: 420, nearOffset: 0, farOffset: 240 },
    altLines: [
  ...
  props: [
    ...
    { id: 'banner-start', kind: 'banner', position: [-22, 418, 28], rotationY: 0.35, label: 'SLOW DOWN', recovery: true },
    { id: 'banner-bowl', kind: 'banner', position: [26, 278, 1160], rotationY: -0.2, label: 'CAUTION', recovery: true },
    { id: 'fence-start-l', kind: 'fence', position: [-48, 410, 80], rotationY: 0.1, length: 14, recovery: true },
    { id: 'fence-start-r', kind: 'fence', position: [50, 410, 90], rotationY: -0.08, length: 12, recovery: true },
    { id: 'fence-mid-l', kind: 'fence', position: [-54, 300, 1000], rotationY: 0.12, length: 16, recovery: true },
    ...
    // Dense apron anchors — procedural belts fill remaining Lod tree slots.
    ...
    { id: 'tree-edge-d', kind: 'tree', position: [62, 362, 250], variant: 0, recovery: true },
    { id: 'tree-edge-e', kind: 'tree', position: [-60, 355, 280], variant: 2, recovery: true },
    { id: 'tree-edge-f', kind: 'tree', position: [64, 350, 320], variant: 1, recovery: true },
    ...
    { id: 'tree-powder-4', kind: 'tree', position: [-80, 325, 620], variant: 1, recovery: true },
    { id: 'tree-powder-5', kind: 'tree', position: [-74, 318, 700], variant: 0, recovery: true },
    { id: 'tree-right-1', kind: 'tree', position: [68, 320, 640], variant: 2, recovery: true },
    { id: 'tree-right-2', kind: 'tree', position: [74, 300, 880], variant: 0, recovery: true },
    { id: 'tree-right-3', kind: 'tree', position: [70, 270, 1180], variant: 1, recovery: true },
    { id: 'tree-right-4', kind: 'tree', position: [66, 230, 1480], variant: 2, recovery: true },
    { id: 'tree-village-1', kind: 'tree', position: [-58, 170, 1880], variant: 0, recovery: true },
    { id: 'tree-village-2', kind: 'tree', position: [56, 165, 1900], variant: 1, recovery: true },
...
export const TIMBERLINE: CourseDef = {
  ...
  terrain: {
    ...
    roughness: 0.78,
    reliefScale: 1.35,
    backdrop: { peakHeight: 400, nearOffset: 0, farOffset: 220 },
    altLines: [
  ...
  props: [
    ...
    { id: 'banner-entry', kind: 'banner', position: [172, 390, 20], rotationY: 0.25, label: 'SLOW DOWN', recovery: true },
    { id: 'banner-tunnel', kind: 'banner', position: [88, 302, 680], rotationY: 0.4, label: 'CAUTION', recovery: true },
    { id: 'fence-entry-l', kind: 'fence', position: [170, 392, 10], rotationY: 0.2, length: 12, recovery: true },
    { id: 'fence-entry-r', kind: 'fence', position: [198, 392, 25], rotationY: 0.15, length: 10, recovery: true },
    { id: 'fence-chute-l', kind: 'fence', position: [95, 310, 520], rotationY: 0.35, length: 14, recovery: true },
    { id: 'fence-chute-r', kind: 'fence', position: [130, 308, 540], rotationY: 0.3, length: 12, recovery: true },
    ...
    { id: 'tree-03b', kind: 'tree', position: [192, 374, 120], variant: 0 },
    ...
    { id: 'tree-06b', kind: 'tree', position: [170, 342, 300], variant: 1 },
    ...
    { id: 'tree-09b', kind: 'tree', position: [128, 310, 510], variant: 0 },
    ...
    { id: 'tree-12b', kind: 'tree', position: [90, 272, 760], variant: 1 },
    ...
    { id: 'tree-15b', kind: 'tree', position: [48, 232, 1020], variant: 0 },
    { id: 'tree-16', kind: 'tree', position: [-8, 210, 1220], variant: 0 },
    { id: 'tree-17', kind: 'tree', position: [-20, 200, 1280], variant: 1 },
    { id: 'tree-18', kind: 'tree', position: [-28, 190, 1340], variant: 2 },
    { id: 'tree-19', kind: 'tree', position: [-12, 180, 1400], variant: 0 },
    { id: 'tree-20', kind: 'tree', position: [-38, 155, 1580], variant: 1 },
    ...
    { id: 'tree-sc-5', kind: 'tree', position: [42, 262, 940], variant: 1, recovery: true },
...
export const SUMMIT_DROP: CourseDef = {
  ...
  terrain: {
    ...
    roughness: 0.74,
    reliefScale: 1.3,
    backdrop: { peakHeight: 460, nearOffset: 0, farOffset: 260 },
